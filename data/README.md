# README
All data in this folder needs to be created locally using the **original Fish Tether Experiment repository** due to large file sizes.

**The information below was taken from original repository:**
